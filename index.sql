...
--Sair da conta do aluno anterior.
\q;

--Sair do usuário postgres.
exit;

--Entrar na conta postgres.
sudo -i -u postgres

--Excluir usuário caso já exista.
DROP USER davicarretta;

--Excluir banco de dados caso já exista.
DROP DATABASE uvv;

--Criar usuário com permissões.
CREATE USER davicarretta WITH PASSWORD 'barcellos';
ALTER USER davicarretta CREATEDB;
ALTER USER davicarretta CREATEROLE;

--Sair do usuáro Postgres.
\q
exit;

--Entrar no usuário davicarretta RESOLVEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
psql -U davicarretta;
